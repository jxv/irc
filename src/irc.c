...
const pm_parser_t pass_cmd = PM_STRING(&pass_str);
const pm_parser_t nick_cmd = PM_STRING(&nick_str);
const pm_parser_t user_cmd = PM_STRING(&user_str);
const pm_parser_t oper_cmd = PM_STRING(&oper_str);
const pm_parser_t mode_cmd = PM_STRING(&mode_str);
const pm_parser_t service_cmd = PM_STRING(&service_str);
const pm_parser_t quit_cmd = PM_STRING(&quit_str);
const pm_parser_t join_cmd = PM_STRING(&join_str);
const pm_parser_t part_cmd = PM_STRING(&part_str);
const pm_parser_t topic_cmd = PM_STRING(&topic_str);
const pm_parser_t names_cmd = PM_STRING(&names_str);
const pm_parser_t list_cmd = PM_STRING(&list_str);
const pm_parser_t invite_cmd = PM_STRING(&part_str);
const pm_parser_t kick_cmd = PM_STRING(&kick_str);
const pm_parser_t privmsg_cmd = PM_STRING(&privmsg_str);
const pm_parser_t notice_cmd = PM_STRING(&notice_str);
const pm_parser_t lusers_cmd = PM_STRING(&lusers_str);
const pm_parser_t version_cmd = PM_STRING(&version_str);
const pm_parser_t stats_cmd = PM_STRING(&stats_str);
const pm_parser_t links_cmd = PM_STRING(&links_str);
const pm_parser_t time_cmd = PM_STRING(&time_str);
const pm_parser_t connect_cmd = PM_STRING(&connect_str);
const pm_parser_t trace_cmd = PM_STRING(&trace_str);
const pm_parser_t admin_cmd = PM_STRING(&admin_str);
const pm_parser_t info_cmd = PM_STRING(&info_str);
const pm_parser_t servlist_cmd = PM_STRING(&servlist_str);
const pm_parser_t squery_cmd = PM_STRING(&squery_str);
const pm_parser_t who_cmd = PM_STRING(&who_str);
const pm_parser_t whois_cmd = PM_STRING(&whois_str);
const pm_parser_t kill_cmd = PM_STRING(&kill_str);
const pm_parser_t ping_cmd = PM_STRING(&ping_str);
const pm_parser_t pong_cmd = PM_STRING(&pong_str);
const pm_parser_t error_cmd = PM_STRING(&error_str);
const pm_parser_t away_cmd = PM_STRING(&away_str);
const pm_parser_t rehash_cmd = PM_STRING(&rehash_str);
const pm_parser_t die_cmd = PM_STRING(&die_str);
const pm_parser_t restart_cmd = PM_STRING(&restart_str);
const pm_parser_t summon_cmd = PM_STRING(&summon_str);
const pm_parser_t users_cmd = PM_STRING(&users_str);
